...
import com.alpa.apiMaterial.schema.xmlns.apps.scm.productcatalogmanagement.advanceditems.flex.egoitemeff.itemrevision.contexts.*;
...
/**
 * <p>Java class for ItemRevisionEffBase complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ItemRevisionEffBase"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ItemRevisionEffBase", propOrder = {
    "contextCode",
    "createdBy",
    "creationDate",
    "effLineId",
...
@XmlSeeAlso({
    DadosDeCentroSku.class,
    XxalpaHierarquiaDeMaterial.class,
    ListaTecnica.class,
    EstruturaComercialPim.class,
    Matriz.class,
    DadosDeCentroMaterial.class,
    DadosEanEDuns.class,
    EstruturaComercialSku.class,
    XxalpaEstruturaMaterial.class
})
public class ItemRevisionEffBase {
