...
package com.alpa.apiMaterial.schema.xmlns.apps.scm.productmodel.items.flex.itemrevision;
...
/**
 * <p>Java class for ItemRevisionDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ItemRevisionDFF"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ItemRevisionDFF", propOrder = {
    "revisionId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class ItemRevisionDFF {

    @XmlElement(name = "RevisionId")
    protected Long revisionId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/scm/productModel/items/flex/itemRevision/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/scm/productModel/items/flex/itemRevision/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/scm/productModel/items/flex/itemRevision/", type = JAXBElement.class, required = false)
